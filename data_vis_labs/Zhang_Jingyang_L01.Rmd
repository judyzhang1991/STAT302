...
<strong> `<-` evaluates the the expression on its right side and assign the evaluated value to the symbol (variable) on the left side (x) in the current environment. `=` evaluates the expression on its right side and set the evaluated value to the parameter of the name specified on the left side (formula) for a certain function.</strong>
